...
class InvoiceDownloadModel {
  ...
  factory InvoiceDownloadModel.empty() => InvoiceDownloadModel(
        fileName: '',
        data: '',
  ...
  factory InvoiceDownloadModel.fromMap(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'InvoiceDownloadModel(fileName: $fileName, type: $type, status: $status, dataLength: ${data.length})';
  }
}
