...
class QuoteDownloadModel {
  ...
  factory QuoteDownloadModel.empty() => QuoteDownloadModel(
        fileName: '',
        data: '',
  ...
  Future<File?> savePdf() async {
    try {
      ...
      print('Quote File saved at: $filePath');
      return file;
    } catch (e) {
      print('Error saving Quote PDF: $e');
      return null;
    }
  }

  factory QuoteDownloadModel.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'QuoteDownloadModel(fileName: $fileName, type: $type, status: $status, dataLength: ${data?.length ?? 0})';
  }
}
