...
class GetCustomerListModel {
  ...
  factory GetCustomerListModel.fromJson(String str) =>
      GetCustomerListModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetCustomerListModel.fromMap(Map<String, dynamic> json) {
    print('GetCustomerListModel.fromMap - Processing response');
    print('Top level keys: ${json.keys.join(", ")}');

    return GetCustomerListModel(
  ...
  factory GetCustomerListModel.empty() => GetCustomerListModel(
        error: false,
        errorMsg: null,
        successMsg: null,
...
class CustomerListResponse {
  ...
  factory CustomerListResponse.fromMap(Map<String, dynamic> json) {
    ...
    return CustomerListResponse(
      response: List<Customer>.from(customersList.map((x) {
        if (x is Map) {
          return Customer.fromMap(Map<String, dynamic>.from(x));
        } else {
