...
class OrderDownloadModel {
  ...
  factory OrderDownloadModel.empty() => OrderDownloadModel(
        fileName: '',
        data: '',
  ...
  Future<File?> savePdf() async {
    try {
      ...
      print('Order File saved at: $filePath');
      return file;
    } catch (e) {
      print('Error saving Order PDF: $e');
      return null;
    }
  }

  factory OrderDownloadModel.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'OrderDownloadModel(fileName: $fileName, type: $type, status: $status, dataLength: ${data?.length ?? 0})';
  }
}
