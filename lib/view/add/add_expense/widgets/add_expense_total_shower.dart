  ...
  import 'add_expense_total_widget.dart'; // adjust path if needed
  ...
  class AddExpenseTotalShower extends ConsumerWidget {
    ...
    Widget build(BuildContext context, WidgetRef ref) {
      ...
      final subTotalStr = '$currencyCode ${numberFormatter.format(subtotalVal).trim()}';
      final taxAmountStr = '$currencyCode ${numberFormatter.format(taxAmountVal).trim()}';
