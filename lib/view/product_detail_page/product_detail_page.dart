...
//     final productData = ref.watch(getProductData);
...
//     final TextEditingController purchaseDescriptionController = TextEditingController();
//     final TextEditingController skuController = TextEditingController();
//     final TextEditingController exceptionReasonController = TextEditingController();
...
//                   SizedBox(height: 16),
//                   Text("Error loading product details", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
//                   SizedBox(height: 16),
//                   ElevatedButton(
//                     onPressed: () => ref.refresh(getProductData),
//                     child: Text("Retry"),
//                   ),
//                 ],
//               ),
...
//     final selectedProduct = productData.value?.response.data.firstWhere(
//             (p) => p.itemId == selectedProductId,
//         orElse: () => ProductData.empty());

//     if (selectedProduct == null || selectedProduct.itemId == 0) {
//       return ScalingFactor(
//         child: SafeArea(
//           child: Scaffold(
//             appBar: reusableAppBar(
...
//     exceptionReasonController.text = selectedProduct.taxExceptionReason ?? '';
...
//                     PayzoInputField(enabled: false, label: 'Item Name', controller: itemNameController),
...
//                               orElse: () => Unit(unitId:selectedProduct.unitId,displayUnit: 'Unknown'),
//                             );
...
//                         FormRadioButton(
//                           value: 'goods',
//                           groupValue: selectedProduct.fixedAsset ? 'Service' : 'goods',
//                           title: 'Goods',
//                           onChanged: (_) {},
//                         ),
//                         SizedBox(height: 16),
...
//                     SizedBox(height: 8),
//                     PayzoDivider(),
//                     PayzoInputField(enabled: false, label: 'HSN Code', controller: hsnCodeController),
//                     ReusableSizedBox(height: 8),
...
//                     SizedBox(height: 8),
//                     CustomToggleTile(disableSwitch:true,title: 'Taxable', value: selectedProduct.taxable == 1, onChanged: (value) => false, divider: false)
//                   ],
//                 ),
//               ),
//             ),
...
//                 child: ReusableColumn(children: [
//                   CustomToggleTile(disableSwitch:true,title: 'Sales Information', value: true, onChanged: (value) {}, divider: true),
//                   PayzoInputField(enabled: false, label: 'Sales Price', controller: sellingPriceController),
//                   ReusableSizedBox(height: 15),
//                   PayzoBottomsheetNavigator(
//                       navigationButton: false,
//                       isPayzoColor: true, title: 'Account', trailing: selectedProduct.salesAccountName, onTap: () {}),
//                   ReusableSizedBox(height: 15),
//                   CustomDescriptionField(enabled: false, title: 'Description', controller: salesDescriptionController)
//                 ]),
//               ),
//             ),
//             ReusableSizedBox(height: 15),
...
//                 padding: const EdgeInsets.only(top: 18, bottom: 18, left: 15, right: 15),
//                 child: ReusableColumn(children: [
//                   CustomToggleTile(disableSwitch:true,title: 'Purchase Information', value: true, onChanged: (value) {}, divider: true),
//                   PayzoInputField(enabled: false, label: 'Purchase Rate', controller: costPriceController),
//                   ReusableSizedBox(height: 15),
//                   PayzoBottomsheetNavigator(
//                       navigationButton: false,
//                       isPayzoColor: true, title: 'Account', trailing: selectedProduct.costAccountName, onTap: () {}),
//                   ReusableSizedBox(height: 15),
//                   CustomDescriptionField(enabled: false, title: 'Description', controller: purchaseDescriptionController)
//                 ]),
//               ),
//             ),
//           ]),
