...
//       final displayText = fullName.isNotEmpty
//           ? fullName
//           : (vendor.displayName?.isNotEmpty == true
//               ? vendor.displayName!
...
Widget vendorBodyListView(VendorPaginationState paginationState,
  ...
  return ListView.builder(
    ...
    itemBuilder: (context, index) {
      ...
      final displayText = fullName.isNotEmpty ? fullName : vendor.displayName;
      ...
      // ✅ Debug log to track all vendors
      developer.log(
          'Displaying vendor: ${vendor.displayName} (ID: ${vendor.partyId}), '
          'fullName: "$fullName", displayText: "$displayText"',
          name: 'VendorListView');

      return GestureDetector(
        onTap: () {
          developer.log('Vendor tapped: $displayText (ID: ${vendor.partyId})',
              name: 'VendorListView');
