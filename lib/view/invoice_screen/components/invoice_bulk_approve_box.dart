    ...
    builder: (dialogContext) => AlertDialog(
      ...
      actions: [
        PayzoFormSubmitTwoButtons(
            ...
            saveOnPressed: () {
              Navigator.pop(context);
              bulkApproveResultAlert(context, onApprove);
            })
      ],
    ),
  );
    ...
    builder: (dialogContext) => AlertDialog(
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ReusableText(
              text: 'Total Invoice(s) For Approval : ',
              fontFamily: 'SF Pro Display',
              fontWeight: FontWeight.w600,
            ),
            ReusableText(
              text: 'Number of Invoice(s) Approved : ',
              fontFamily: 'SF Pro Display',
              fontWeight: FontWeight.w600,
            ),
            ReusableText(
              text: 'Number of Invoice(s) Failed : ',
              fontSize: 14,
              fontFamily: 'SF Pro Display',
              fontWeight: FontWeight.w600,
            ),
