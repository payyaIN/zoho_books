...
class InvoiceSelectionNotifier extends StateNotifier<InvoiceSelectionState> {
  InvoiceSelectionNotifier() : super(InvoiceSelectionState());
...
final invoiceSelectionProvider =
    StateNotifierProvider<InvoiceSelectionNotifier, InvoiceSelectionState>(
        (ref) {
  return InvoiceSelectionNotifier();
});
