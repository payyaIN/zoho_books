...
import 'package:payzo_books/data/models/product_model/product_list_model.dart';
import 'package:payzo_books/import_data.dart';
import 'package:payzo_books/view/product_page/components/product_util.dart';
import 'package:payzo_books/view/product_page/provider/product_selection.dart';
...
Widget productItemWidget({
  ...
  String quantityDisplay =
      product.stockable ? "${product.costRate.toStringAsFixed(2)} pcs" : "";
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.end,
                        children: [
                          // ❌ OLD (BROKEN) - Only checks for null:
                          // product.hsnOrSac == null

                          // ✅ NEW (FIXED) - Checks for both null and empty string:
                          (product.hsnOrSac.isNotEmpty)
                              ? ReusableText(
                                  text: "HS Code: ${product.hsnOrSac}",
                                  color: Color(0xFF333333),
                                  fontSize: 12,
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        ReusableText(
                          text:
                              "Tax: ${product.taxable == 1 ? 'Taxable' : 'Non-Taxable'}",
                          color: Color(0xFF555555),
                          fontSize: 12,
                          fontWeight: FontWeight.w400,
                        ),
